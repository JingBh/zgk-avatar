  ...
  data () {
    return {
      bgImages: [
        ...
        '/assets/images/bg/14.png',
        '/assets/images/bg/15.jpg',
        '/assets/images/bg/16.jpg',
        '/assets/images/bg/17.jpg',
        '/assets/images/bg/18.jpg',
        '/assets/images/bg/19.jpg',
        '/assets/images/bg/20.jpg',
        '/assets/images/bg/21.jpg',
        '/assets/images/bg/22.jpg',
        '/assets/images/bg/23.jpg',
        '/assets/images/bg/24.jpg',
        '/assets/images/bg/25.jpg',
        '/assets/images/bg/26.jpg',
        '/assets/images/bg/27.jpg',
        '/assets/images/bg/28.jpg',
        '/assets/images/bg/29.jpg',
        '/assets/images/bg/30.jpg',
        '/assets/images/bg/31.jpg',
        '/assets/images/bg/32.jpg',
        '/assets/images/bg/33.jpg',
